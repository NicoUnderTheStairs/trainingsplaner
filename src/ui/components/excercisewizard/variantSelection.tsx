        ...
        <div className="excercisewizard__variant__list">
          {filtered.map((ex) => {
            ...
            return (
              <button
                key={ex.id}
                className={`excercisewizard__variant__item ${
                  isSelected
                    ? "excercisewizard__variant__item--selected"
                    : ""
                }`}
              ...
              >
                ...
                <div
                  className={`excercisewizard__variant__item__check ${
                    isSelected
                      ? "excercisewizard__variant__item__check--active"
                      : ""
                  }`}
                >
                  {isSelected && (
